...
(function() {
  ...
  App = (function() {
    function App() {
      return ['ionic', 'templates', 'ngCordova'];
    }
...
(function() {
  ...
  App = (function() {
    function App($scope, $timeout, $ionicSideMenuDelegate, $ionicPlatform, $cordovaSplashscreen) {
      this.$scope = $scope;
  ...
  angular.module('starter').controller('appController', ['$scope', '$timeout', '$ionicSideMenuDelegate', '$ionicPlatform', '$cordovaSplashscreen', App]);
